...
<main>
    ...
    <div class="container-sm text-center">
        <div class="row">
            <p><?php echo 'Welcome Chef, ' . htmlspecialchars($_SESSION['user_name']) . '!'. ' add New Recipes.'; ?>
                <br>
    ...
    <div class="container-sm text-center">
        ...
        title="Upload Image">Upload Image</button>
...
<button id="editRecipeBtn" type="button" class="btn btn-primary"
        ...
        title="Edit Recipe">Edit Recipe</button>
...
<button type="button" class="btn btn-danger"
        ...
        title="Delete Recipe">Delete Recipe</button>
