      ...
      <div class="recipe-page">
        <section class="recipe-hero">
          ...
          <article class="recipe-info">
            <h2>This Nigerian Egusi Soup recipe.</h2>
            <p>
...
Nigerian Egusi Soup is a soup thickened with ground melon seeds and contains leafy and other vegetables.  It is one of the most popular soups prepared by most tribes in Nigeria with considerable variation and often eaten with dishes like Pounded Yams.  Prepare it with goat, beef, fish, or shellfish!!!.
            ...
            <h1> How to cook Egusi Soap Video</h1>
            <iframe width="560" height="315" src="https://www.youtube.com/embed/LqGj3_UT9h8?si=feQ5-Lh8bLpD7FKI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
Stir and put a lid on the pot and allow cook for 7–10 minutes, till the leaves wilt.
          ...
          <article class="second-column">
            <div>
              <h4>ingredients</h4>
              <p class="single-ingredient">1 1/2 cups blended onions </p>
              <p class="single-ingredient">1/2 - cup palm oil</p>
              <p class="single-ingredient"> 7-8 cups  of oil </p>
            </div>
            <div>
              <h4>tools</h4>
